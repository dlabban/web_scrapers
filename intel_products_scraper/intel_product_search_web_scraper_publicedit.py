...
def selenium_bs4_extractor(terms):
    ...
    for term in terms:
        ...
        driver = webdriver.Chrome(r'C:\Users\dlabban\PycharmProjects\pythonProject\chromedriver_win32\chromedriver.exe')
        driver.get(url)
        time.sleep(10)
        ...
        #creating intermediate df for troubleshooting purposes
        intermediate_terms_df = pd.DataFrame()
        while page_counter < max_page_count:
            ...
            try:
                ...
                for item in all_results:
                    ...
                    intermediate_terms_df.append(results_dict, ignore_index=True)
            except:
        ...
        intermediate_terms_df.to_csv(rf'C:\Users\dlabban\OneDrive - Intel Corporation\Desktop\Data Engineering GIG\output\debugging_inclusive_language_scraper_{term}.csv', encoding='utf-8') #for troubleshooting
        driver.close()
    return results_df
...
if __name__ == "__main__":
    ...
    results_df = selenium_bs4_extractor(terms)
    results_df.to_csv(rf'C:\Users\dlabban\OneDrive - Intel Corporation\Desktop\Data Engineering GIG\output\debugging_inclusive_language_scraper_final_df.csv', encoding='utf-8')